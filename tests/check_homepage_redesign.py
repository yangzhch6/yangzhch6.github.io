...
assert "Research Themes" not in about, "Old portrait label should be removed from homepage source."
assert "Research Interests" in about, "Updated portrait label should appear in homepage source."
...
assert 'class="home-link-list__label"' in about, "Homepage links should include labeled icon wrappers in homepage source."
assert 'class="home-link-list__icon"' in about, "Homepage links should include icon wrappers in homepage source."
...
if preview is not None:
    ...
    assert "Research Themes" not in preview, "Old portrait label should be removed from preview."
    assert "Research Interests" in preview, "Updated portrait label should appear in preview."
    assert "agentic reasoning" in preview_compact, "Agentic reasoning should appear in preview."
    assert 'class="home-link-list__label"' in preview, "Homepage links should include labeled icon wrappers in preview."
    assert 'class="home-link-list__icon"' in preview, "Homepage links should include icon wrappers in preview."
...
assert ".home-link-list__label {" in scss, "Homepage link labels should have dedicated inline-flex styling."
assert ".home-link-list__icon {" in scss, "Homepage link icons should have dedicated styling."
